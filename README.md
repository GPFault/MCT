![Example-Logo](https://i.imgur.com/WMK3apN.png)
# MCT Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a MCT Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/6KArazq)
***
## Requirements
1) **15,000 MCT coins.**
...
***Step 1***
* Download and install the MCT wallet [here](https://bitcointalk.org/index.php?topic=4315891)
***

***Step 2***
* Send EXACLY 15,000 MCT to a receive address within your wallet.
***
